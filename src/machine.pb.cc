...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::machine::Machine_Memory, mem_avaialable_),
...
const int Machine_Memory::kMemAvaialableFieldNumber;
...
void Machine_Memory::SerializeWithCachedSizes(
  ...
  // int32 mem_avaialable = 2;
  if (this->mem_avaialable() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(2, this->mem_avaialable(), output);
  }
...
::google::protobuf::uint8* Machine_Memory::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 mem_avaialable = 2;
  if (this->mem_avaialable() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->mem_avaialable(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:machine.Machine.Memory)
  ...
  if (from.mem_avaialable() != 0) {
    set_mem_avaialable(from.mem_avaialable());
  }
  if (from.mem_free() != 0) {
...
void Machine_Memory::InternalSwap(Machine_Memory* other) {
  ...
  swap(mem_avaialable_, other->mem_avaialable_);

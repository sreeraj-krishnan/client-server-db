...
class Machine_Memory : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:machine.Machine.Memory) */ {
 public:
  ...
  void clear_mem_avaialable();
  static const int kMemAvaialableFieldNumber = 2;
  ::google::protobuf::int32 mem_avaialable() const;
  void set_mem_avaialable(::google::protobuf::int32 value);
 ...
 private:
  ...
  ::google::protobuf::int32 mem_avaialable_;
...
// int32 mem_avaialable = 2;
inline void Machine_Memory::clear_mem_avaialable() {
  mem_avaialable_ = 0;
}
inline ::google::protobuf::int32 Machine_Memory::mem_avaialable() const {
  // @@protoc_insertion_point(field_get:machine.Machine.Memory.mem_avaialable)
  return mem_avaialable_;
}
inline void Machine_Memory::set_mem_avaialable(::google::protobuf::int32 value) {
  
  mem_avaialable_ = value;
  // @@protoc_insertion_point(field_set:machine.Machine.Memory.mem_avaialable)
}

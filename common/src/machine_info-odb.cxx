...
namespace odb
{
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    b[n].type = pgsql::bind::bigint;
    b[n].buffer = &i.time_stamp_value;
    b[n].is_null = &i.time_stamp_null;
    n++;
  }
        ...
        pgsql::statement_kind sk)
  {
    ...
    //
    {
      ...
      pgsql::value_traits<
        ...
        i.time_stamp_value, is_null, v);
      i.time_stamp_null = is_null;
    }
  ...
  "\"process_running\"=$8, "
  "\"process_blocked\"=$9, "
  "\"system_info_system_ip\"=$10, "
  "\"system_info_system_name\"=$11, "
  "\"time_stamp\"=$12 "
  "WHERE \"id\"=$13";
